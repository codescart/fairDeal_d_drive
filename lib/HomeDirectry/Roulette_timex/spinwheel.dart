...
class _CasinoState extends State<Casino> with SingleTickerProviderStateMixin{
  ...
  betconfirm() async{
    ...
    final response = await http.post(
      Uri.parse(
          "https://realdeal.apponrent.com/betlock.php?gameid=1&userid=$userid&gamesno=$gmno&gametype=1"),
    );
    final data = jsonDecode(response.body);
    print("https://realdeal.apponrent.com/betlock.php?gameid=1&userid=$userid&gamesno=$gmno&gametype=1");
    print('raja');
    if (data['error'] == "200") {
