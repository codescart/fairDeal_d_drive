...
class _neighbourbetState extends State<neighbourbet> {
  ...
  betlog({required int bet, required amount, required String betimg}) async{
    ...
    final response = await http.post(
      Uri.parse(
          "https://realdeal.apponrent.com/bet.php?gamesno=$gano&amount=$amount&userid=$userid&gameid=1&bet=$bet&gametype=1"),
    );
  ...
  yui()async{
    ...
    final res= await http.get(Uri.parse('https://realdeal.apponrent.com/showcurrentbet.php?&userid=$userid&gametype=1&gameid=1'));
