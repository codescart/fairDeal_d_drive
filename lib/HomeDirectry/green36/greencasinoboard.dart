...
class greenroulettelayout extends StatefulWidget {
  ...
  final bool chuga;
  final int time;
  greenroulettelayout({Key? key, required this.widths, required this.heights, required this.result, required this.gnno, required this.chuga, required this.time}) : super(key: key);
...
print(_clockModel.second);
                ...
                children: [
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(
                              fit: BoxFit.fill,
                              image: AssetImage('assets/greengrid.png')
                          )
                      ),
                      child:
                      Stack(
                        ...
                        children: [
                          GridView.builder(
                              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                ...
                                //widget.widths*0.750/(widget.widths*0.115),
                              ),
                                    ...
                                    children: [
                                      Container(
                                          ...
                                          child:    Stack(
                                              clipBehavior: Clip.none,
                                              children: [
                                                // Positioned(child: data[index].toString()==widget.result && chug==false?
                                                // Center(child:
                                                // Container(
                                                //
                                                //     child:  Transform(
   ...
   betlog({required int bet, required amount, required String betimg}) async{
    ...
    if(amount != 'rem'){
      final response = await http.get(
        Uri.parse(
            "https://realdeal.apponrent.com/bet.php?gamesno=$gmno&amount=$amount&userid=$userid&gameid=2&bet=$bet&gametype=1"),
      );
      ...
      final response = await http.get(
        Uri.parse(
          "https://realdeal.apponrent.com/removelastnumber.php?gameid=2&gametype=1&gamesno=$gmno&userid=$userid&betno=$bet"
        ),
      );
    }
  ...
  yui() async{
    ...
    final res= await http.get(Uri.parse('https://realdeal.apponrent.com/showcurrentbet.php?gamesno=$gmno&userid=$userid&gametype=1&gameid=2'));
